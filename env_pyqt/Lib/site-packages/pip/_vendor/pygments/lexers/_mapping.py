...
LEXERS = {
    ...
    'DockerLexer': ('pip._vendor.pygments.lexers.configs', 'Docker', ('docker', 'dockerfile'), ('Dockerfile', '*.docker'), ('text/x-dockerfile-config.py',)),
    ...
    'KconfigLexer': ('pip._vendor.pygments.lexers.configs', 'Kconfig', ('kconfig', 'menuconfig', 'linux-config.py', 'kernel-config.py'), ('Kconfig*', '*Config.in*', 'external.in*', 'standard-modules.in'), ('text/x-kconfig',)),
    ...
    'UnixConfigLexer': ('pip._vendor.pygments.lexers.configs', 'Unix/Linux config.py files', ('unixconfig', 'linuxconfig'), (), ()),
