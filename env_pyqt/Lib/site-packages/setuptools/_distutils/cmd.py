...
class Command:
    ...
    world (command line, config.py file, ...), and any options dependent on
    ...
    #     setup script, by options from config.py file(s), or by command-line
    #     options
    #   finalize_options()
    ...
    def initialize_options(self):
        ...
        commands, by the setup script, by config.py files, or by the
    ...
    def run(self):
        ...
        script, the command-line, and config.py files, and finalized in
